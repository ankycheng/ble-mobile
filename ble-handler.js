...
function gotCharacteristics(error, characteristics) {
  ...
  BLEState.myCharacteristic = characteristics.find((c) => c.uuid === BLEConfig.characteristicUUID);
...
function gotCharacteristics(error, characteristics) {
  ...
  BLEState.myCharacteristic = characteristics.find(c => c.uuid === BLEConfig.characteristicUUID);
  BLEState.calibrationCharacteristic = characteristics.find(c => c.uuid === BLEConfig.calibrationCharacteristicUUID);
  BLEState.distanceCharacteristic = characteristics.find(c => c.uuid === BLEConfig.distanceCharacteristicUUID);
  BLEState.isConnected = true;
...
function updateBLEDistance(isNearTower) {
  if (BLEState.distanceCharacteristic) {
    BLEState.myBLE.write(BLEState.distanceCharacteristic, isNearTower ? "1" : "0");
  }
}
